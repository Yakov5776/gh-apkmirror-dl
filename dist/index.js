...
var types_1 = __nccwpck_require__(399);
...
/* harmony export */   "P": () => (/* binding */ getVariants)
/* harmony export */ });
/* harmony import */ var cheerio__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(169);
/* harmony import */ var _fetch_js__WEBPACK_IMPORTED_MODULE_4__ = __nccwpck_require__(13);
/* harmony import */ var fs__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(147);
/* harmony import */ var stream__WEBPACK_IMPORTED_MODULE_2__ = __nccwpck_require__(781);
/* harmony import */ var stream_promises__WEBPACK_IMPORTED_MODULE_3__ = __nccwpck_require__(845);
...
async function getHtmlForApkMirror(url) {
    return (0,_fetch_js__WEBPACK_IMPORTED_MODULE_4__/* .fetchHeaders */ .r)(BASE_URL + url).then((r) => r.text());
}
...
async function getStableLatestVersion(org, repo) {
    ...
    const response = await (0,_fetch_js__WEBPACK_IMPORTED_MODULE_4__/* .fetchHeaders */ .r)(apkmUrl);
...
async function getVariants(org, repo, version, bundle) {
...
async function downloadAPK(url, name) {
    const response = await (0,_fetch_js__WEBPACK_IMPORTED_MODULE_4__/* .fetchHeaders */ .r)(url);
    let filename = name;
    ...
    if (body != null && isAPK) {
        const fileStream = (0,fs__WEBPACK_IMPORTED_MODULE_1__.createWriteStream)(filename, { flags: "w" });
        await (0,stream_promises__WEBPACK_IMPORTED_MODULE_3__.finished)(stream__WEBPACK_IMPORTED_MODULE_2__.Readable.fromWeb(body).pipe(fileStream));
    } else {
...
/* harmony export */ __nccwpck_require__.d(__webpack_exports__, {
/* harmony export */   "r": () => (/* binding */ fetchHeaders)
/* harmony export */ });
// fetch.js
...
__nccwpck_require__.d(__webpack_exports__, {
  "ZP": () => (/* binding */ cheerio_lib_esm)
});

// UNUSED EXPORTS: contains, html, load, merge, parseHTML, root, text, xml
...
var commonjs = __nccwpck_require__(720);
// EXTERNAL MODULE: ./node_modules/boolbase/index.js
var boolbase = __nccwpck_require__(618);
...
/******/ var __webpack_exports__getVariants = __webpack_exports__.P;
/******/ export { __webpack_exports__getVariants as getVariants };
/******/ 
